...
- GAS 프로젝트: C:\Users\leftj\Documents\바이브 코딩\gas-nametag\
...
```
### Step N: GAS 배포
- 파일: C:\Users\leftj\Documents\바이브 코딩\gas-nametag\Code.js
- 작업:
  ```bash
  cd "C:\Users\leftj\Documents\바이브 코딩\gas-nametag"
  clasp push
  ```
